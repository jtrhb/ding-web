...
export function ContentEditor({ onContentChange }: ContentEditorProps) {
  ...
  return (
    <div className="p-6 space-y-6" data-oid="lfp-1ic">
      {/* 标题输入区域 */}
      <div className="space-y-3" data-oid="v48e285">
        <label className="text-sm font-medium text-gray-700" data-oid="qsn1u9o">
          笔记标题
        </label>
        <div className="relative" data-oid="sap-tbv">
          <Input
      ...
      {/* 正文输入区域 */}
      <div className="space-y-3" data-oid="zmb2ynt">
        <label className="text-sm font-medium text-gray-700" data-oid="fpj78ga">
          正文内容
        </label>
        <div className="relative" data-oid="t.yvc9p">
          <Textarea
