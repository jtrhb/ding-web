...
export function ContentEditor({ onContentChange }: ContentEditorProps) {
  ...
  return (
    <div className="p-6 space-y-6" data-oid="zwcxsqb">
      {/* 标题输入区域 */}
      <div className="space-y-3" data-oid="68y4ojh">
        <label className="text-sm font-medium text-gray-700" data-oid="ngcgp3r">
          笔记标题
        </label>
        <div className="relative" data-oid=".5vmcb2">
          <Input
      ...
      {/* 正文输入区域 */}
      <div className="space-y-3" data-oid="5nv0zjr">
        <label className="text-sm font-medium text-gray-700" data-oid="par.pw:">
          正文内容
        </label>
        <div className="relative" data-oid="yzdtrwh">
          <Textarea
