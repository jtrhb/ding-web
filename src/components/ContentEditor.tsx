      ...
      <div className="space-y-3" data-oid=".5hxnqb">
        ...
        <div className="relative">
          <Input
            ...
            data-oid="ejcd:_1"
          />
          <div className="absolute right-4 top-1/2 transform -translate-y-1/2 text-xs text-gray-400" data-oid="3teyhiw">
            {title.length}/20
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3" data-oid="irlqav9">
        ...
        <div className="relative">
          <Textarea
            ...
            data-oid="o9dyx0g"
          />
          <div className="absolute right-4 bottom-3 text-xs text-gray-400" data-oid="ysv7.-t">
            {content.length}/1000
          </div>
        </div>
      </div>
