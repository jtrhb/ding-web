    ...
    <div className="p-4">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          <span className="text-gray-900">图片编辑</span>
          <span className="text-gray-400 text-sm">({images.length}/9)</span>
          <span className="text-gray-400 text-sm">支持拖拽排序</span>
        </div>
        <span className="text-red-500 text-sm">消费开销上传</span>
      </div>
